      ...
      steps {
        script {
          ...
          withSonarQubeEnv('Sonarqube') {
            ...
            sh "export PATH=${scannerHome}/bin:${nodeJS}/bin:$PATH; sonar-scanner -Dsonar.javascript.lcov.reportPaths=./xunit-reports-current/coverage/lcov.info,./cypress-coverage-current/coverage/lcov.info -Dsonar.sources=./packages/$GIT_NAME/src -Dsonar.projectKey=\"${GIT_NAME}\" -Dsonar.projectName=\"${GIT_NAME}\" -Dsonar.projectVersion=\$(jq '.version' package.json) ${env.sonarParams}"
